...
Here I will not discuss the detailed APIs in each of the interfaces. You can find detailed references of them [here](/site/docs/reference/extensibility-apis "Extensibility API references").
