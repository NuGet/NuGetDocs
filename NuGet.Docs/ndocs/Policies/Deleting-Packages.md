...
NuGet.org does not support permanent deletion of packages. Doing so would break every project depending on the availabiliyt of the package, especially with build workflows that involve package restore.
