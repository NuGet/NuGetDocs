...
This page contains the comprehensive list of the supported extensibility API that are exported via MEF by the NuGet Visual Studio extension. Refer to [this topic]() to learn how to invoke them.
