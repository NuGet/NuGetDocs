...
### Visual Studio Online Package Management
In fall 2015, [Visual Studio Online](https://www.visualstudio.com/products/what-is-visual-studio-online-vs) is launching a public preview of NuGet package hosting. VSO's solution provides
* Private package hosting for your team or entire organization,
* Enterprise-grade security and authentication,
* Seamless integration with other VSO components such as Team Build, and
